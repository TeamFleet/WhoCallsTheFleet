...
}):t.prop({checked:!1,indeterminate:!1})}}).data("ships",$());a.header_checkbox[e]=t}():!function(){var t=i.attr("data-donotcompare"),n=i.attr("data-shipid"),o=i.find('input[type="checkbox"]'),s=e;i.on("click",function(e,i){!i&&"em"!=e.target.tagName.toLowerCase()&&_frame.app_main.is_mode_selection()&&(e.preventDefault(),e.stopImmediatePropagation(),e.stopPropagation(),t||_frame.app_main.mode_selection_callback(n))}),o.prop("disabled",t).on("click change",function(e,t){e.stopImmediatePropagation(),e.stopPropagation(),o.prop("checked")?i.attr("compare-checked",!0):i.removeAttr("compare-checked"),this.compare_btn_show(o.prop("checked")),t||this.header_checkbox[s].trigger("docheck")}.bind(a)),a.header_checkbox[s].data("ships",a.header_checkbox[s].data("ships").add(i)),i.data("checkbox",o),a.checkbox[n]=o}()}.bind(this)),this.mark_high(),this.thead_redraw(),_frame.app_main.loaded("tablelist_"+this._index,!0),delete this.last_item}}]),t}(Tablelist);