...
module.exports = __webpack_require__(54) || !__webpack_require__(4)(function () {
  var K = Math.random();
...
$export($export.S + $export.F * !__webpack_require__(11), 'Object', { defineProperties: __webpack_require__(184) });
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(21)(proto, TO_PRIMITIVE, __webpack_require__(378));
...
$export($export.S + $export.F * !__webpack_require__(97)(function (iter) {
  Array.from(iter);
}), 'Array', {
...
$export($export.P + $export.F * (__webpack_require__(80) != Object || !__webpack_require__(31)(arrayJoin)), 'Array', {
  join: function join(separator) {
...
// https://github.com/tc39/proposal-object-values-entries
var $export = __webpack_require__(0);
var $entries = __webpack_require__(211)(true);
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(495)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
