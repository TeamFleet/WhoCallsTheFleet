	...
	_createClass(InfosFleetShip, [{
		...
		value: function updateEl(d) {
			...
			this.equipments.forEach(function (equipment, i) {
				equipment.id = _this7.data[2][i];
				equipment.star = _this7.data[3][i];
				equipment.rank = _this7.data[4][i];
			});
		...
		set: function set(value) {
			...
			if (value) {
				(function () {
					...
					_this8.el.attr('data-shipId', value);

					_this8.elAvatar.html('<img src="' + ship.getPic(10, _g.imgExt) + '"/>');
					_this8.elInfosTitle.html('<h4 data-content="' + ship['name'][_g.lang] + '">' + ship['name'][_g.lang] + '</h4>' + (suffix ? '<h5 data-content="' + suffix + '">' + suffix + '</h5>' : ''));
					_this8.elInfosInfo.html(speed + ' ' + stype);

					_this8.equipments.forEach(function (equipment, i) {
		...
		this.el = $('<div class="equipment equipment-' + this.index + '" tabindex="0"/>').on({
			...
			'blur': function () {
				...
				this.elBlurTimeout = setTimeout(function () {
					_this9.el.removeClass('is-hover');
			...
			'pointerenter': function (e) {
				...
				if (e.originalEvent.pointerType != 'touch') {
					...
					if (this.index >= 4) {
						(function () {
							var tip = _this10.el.attr('data-tip');
							_this10.el.attr('data-tip', '');
							if (tip) {
								setTimeout(function () {
									_this10.el.attr('data-tip', tip);
									setTimeout(function () {
										if (!_this10.el.data('tip-filtered_')) {
										...
										console.log(_this10.el.attr('data-tip'));
										console.log(_this10.el.data('tip-filtered_'));
										_p.tip.show(_this10.el.data('tip-filtered_'), _this10.el, _this10.el.data('tip-position'));
									}, 100);
								}, 10);
							}
						})();
			...
			'pointerdown': function (e) {
				...
				if (e.originalEvent.pointerType == 'touch') {
					...
					clearTimeout(this.elBlurTimeout);
					setTimeout(function () {
						_this11.elInputStar.trigger('focus');
					}, 10);
				}
			}.bind(this),
			'pointerenter': function (e) {
	...
	'frame': function frame(typeId) {
		...
		if (!this.frames[typeId]) {
			(function () {
				...
				_this13.frames[typeId] = container;
			})();
		}
