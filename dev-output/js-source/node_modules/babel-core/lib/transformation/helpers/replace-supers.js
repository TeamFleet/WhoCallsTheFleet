...
var visitor = {
  enter: function enter(path, state) {
    ...
    if (path.isProperty({ method: true }) || path.isClassMethod()) {
...
var ReplaceSupers = (function () {
  ...
  ReplaceSupers.prototype.setSuperProperty = function setSuperProperty(property /*: Object*/, value /*: Object*/, isComputed /*: boolean*/, thisExpression /*: Object*/) /*: Object*/ {
    return t.callExpression(this.file.addHelper("set"), [t.callExpression(t.memberExpression(t.identifier("Object"), t.identifier("getPrototypeOf")), [this.isStatic ? this.getObjectRef() : t.memberExpression(this.getObjectRef(), t.identifier("prototype"))]), isComputed ? property : t.stringLiteral(property.name), value, thisExpression]);
  };
  ...
  ReplaceSupers.prototype.getSuperProperty = function getSuperProperty(property /*: Object*/, isComputed /*: boolean*/, thisExpression /*: Object*/) /*: Object*/ {
    return t.callExpression(this.file.addHelper("get"), [t.callExpression(t.memberExpression(t.identifier("Object"), t.identifier("getPrototypeOf")), [this.isStatic ? this.getObjectRef() : t.memberExpression(this.getObjectRef(), t.identifier("prototype"))]), isComputed ? property : t.stringLiteral(property.name), thisExpression]);
  };
  ...
  ReplaceSupers.prototype.traverseLevel = function traverseLevel(path /*: NodePath*/, topLevel /*: boolean*/) {
  ...
  ReplaceSupers.prototype.looseHandle = function looseHandle(path /*: NodePath*/, getThisReference /*: Function*/) {
    var node = path.node;
    if (path.isSuper()) {
  ...
  ReplaceSupers.prototype.specHandle = function specHandle(path /*: NodePath*/, getThisReference /*: Function*/) {
    var methodNode = this.methodNode;
