    ...
    init: function init($page) {
        this.object = new (function (_Page) {
            ...
            function _class($page) {
                ...
                var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, $page));
    ...
    init: function init($page) {
        ...
        this.object = new (function (_Page2) {
            ...
            function _class2($page) {
                ...
                var _this2 = _possibleConstructorReturn(this, (_class2.__proto__ || Object.getPrototypeOf(_class2)).call(this, $page));

                _this2.tablelist = $page.find('.tablelist');
                _this2.tablelistObj = _this2.tablelist.data('tablelist');
    ...
    init: function init($page) {
        this.object = new (function (_Page3) {
            ...
            function _class3($page) {
                ...
                var _this3 = _possibleConstructorReturn(this, (_class3.__proto__ || Object.getPrototypeOf(_class3)).call(this, $page));
...
var Journal = function () {
    ...
    _createClass(Journal, [{
        ...
        value: function genTitle() {
            ...
            return $('<' + tagName + '>' + (this.data.hotfix ? '[hotfix] ' : '') + (this.data.type == 'app' ? '' : (this.data.type == 'app-db' ? 'DB' : this.data.type).toUpperCase()) + (this.data.type == 'app' ? this.data.version : '') + '<small>' + (this.data.date ? this.data.date : 'WIP') + '</small>' + ('</' + tagName + '>'));
        }
    }, {
        key: 'genContent',
        ...
        value: function genSection(defaultShow) {
            ...
            var id = 'update_journal_' + this.data._id,
                checkbox = $('<input type="checkbox" id="' + id + '"/>').prop('checked', defaultShow ? !0 : !1).on('change', function (e) {
                if (e.target.checked) _this4.show();
            });
            this.section = $('<section class="update_journal" data-version-' + this.data.type + '="' + this.data.version + '"/>').append($('<label for="' + id + '"/>').append(this.genTitle()));
...
var InfosFleetEditableTitle = function InfosFleetEditableTitle(settings) {
    ...
    var options = $.extend(!0, {}, InfosFleetEditableTitle.defaults, settings);
            ...
            if (this.is_init) {
                ...
                this.fleets.forEach(function (currentValue, i) {
                    if (Array.isArray(currentValue.data) && currentValue.data.length > InfosFleet.minSubFleetShipsCount) {
                        var dataShips = [].concat(_toConsumableArray(currentValue.data));
...
var InfosFleetSubFleet = function () {
    function InfosFleetSubFleet(infosFleet, d, index, label) {
        ...
        this.elSummary = $('<span class="summary"/>').appendTo(this.el).append($('<span class="btn-add-ship"/>').on('click', function () {
            _this7.createShip(_this7.ships.length);
            _this7.ships[_this7.ships.length - 1].el.trigger('click');
    ...
    function InfosFleetShip(infosFleet, infosFleetSubFleet, index, d) {
        ...
        this.el = $('<dd class="ship"/>').append($('<dt/>').append(this.elAvatar = $('<s touch-action="none"/>')).append(this.elInfos = $('<div/>').html('<span>' + (this.infosFleet.data._id ? '选择舰娘' : '无舰娘') + '...</span>').append(this.elInfosTitle = $('<div class="title"/>')).append($('<div class="info"/>').append($('<label/>').html('Lv.').append(this.elInputLevel = $('<input/>', {
            ...
            checkValue: function checkValue() {
                var value = _this8.elInputLevel.val();

                if ((typeof value == 'undefined' || value === '') && _this8.data[1][0]) _this8.shipLv = null;

                value = parseInt(value);
                var min = parseInt(_this8.elInputLevel.attr('min'));
                if (value < min) {
                    value = min;
                    _this8.elInputLevel.val(min);
                } else if (value > _g.shipMaxLv) {
                    value = _g.shipMaxLv;
                    _this8.elInputLevel.val(_g.shipMaxLv);
                }
                if (!isNaN(value) && _this8.data[1][0] != value) _this8.shipLv = value;
            },

            keydown: function keydown(e) {
                if (e.keyCode == 38 || e.keyCode == 40) _this8.elInputLevel.trigger('checkValue');
            },
        ...
        value: function updateEl(d) {
            ...
            if (this.data[0]) {
                ...
                this.equipments.forEach(function (equipment, i) {
                    equipment.id = _this9.data[2][i];
                    equipment.star = _this9.data[3][i];
                    equipment.rank = _this9.data[4][i];
                });
...
InfosFleetShip.dragTouchGetPosition = function () {
    ...
    if (!InfosFleetShip.dragging) return !1;
...
InfosFleetShip.dragTouchmove = function (e) {
    ...
    InfosFleetShip.draggingTouchPosition.some(function (position) {
        ...
        if (isIn) {
            InfosFleetShip.dragging.swap(isIn, !1, InfosFleetShip.dragTouchGetPosition);
        }
...
var InfosFleetShipEquipment = function () {
    function InfosFleetShipEquipment(infosParent, index, carry, equipmentTypes, extraEquipments) {
        ...
        this.elBlurTimeout;
        this.el = $('<div class="equipment equipment-' + this.index + '" tabindex="0"/>').on({
            'focus': function () {
            ...
            'blur': function () {
                ...
                this.elBlurTimeout = setTimeout(function () {
                    _this11.el.removeClass('is-hover');
            ...
            'pointerenter': function (e) {
                ...
                if (e.originalEvent.pointerType != 'touch') {
                    ...
                    if (this.index >= 4) {
                        ...
                        if (tip) {
                            setTimeout(function () {
                                _this12.el.attr('data-tip', tip);
                                setTimeout(function () {
                                    if (!_this12.el.data('tip-filtered_')) {
                                    ...
                                    _p.tip.show(_this12.el.data('tip-filtered_'), _this12.el, _this12.el.data('tip-position'));
                                }, 100);
                            }, 10);
                        }
                    }
            ...
            'pointerdown': function (e) {
                ...
                if (e.originalEvent.pointerType == 'touch') {
                    ...
                    clearTimeout(this.elBlurTimeout);
                    setTimeout(function () {
                        _this13.elInputStar.trigger('focus');
                    }, 10);
                }
            }.bind(this),
            'pointerenter': function (e) {
        ...
        value: function updateEl(d) {
            ...
            if (this.infosFleet.data.name_airfields && this.infosFleet.data.name_airfields.push) {
                this.infosFleet.data.name_airfields.forEach(function (name, i) {
                    _this14.fields[i].elTitle.html(name).trigger('namechange', [name]).trigger('blur');
                });
            }
        ...
        switch (name) {
            ...
            case 'asw':
                ...
                if (val99 || /^(5|8|9|12|24|30)$/.test(d['type'])) {
                    ...
                    val99 = _val(d.getAttribute('asw', 99), !0) + sup;
                    valMax = _val(d.getAttribute('asw', _g.shipMaxLv), !0) + sup;
                } else {
                    val99 = _val(0, !1);
                    valMax = _val(0, !1);
                }
    ...
    return {
        ...
        renderConditionShips: function renderConditionShips(bonus) {
            ...
            if (typeof bonus.ship.isID !== 'undefined') {
                ...
                condition += '<div class="condition">' + ids.map(function (shipId) {
                    ...
                    return '<a class="item ship ship-link" href="' + _g.getLink('ships', ship.id) + '" data-shipid="' + ship.id + '">' + ('<em class="avatar"><img src="' + ship.getPic(0, _g.imgExt) + '"/></em>') + ('' + ship._name) + '</a>';
                }).join('') + '</div>';
            }
            if (typeof bonus.ship.isNotID !== 'undefined') {
                ...
                condition += '<div class="condition">' + _ids.map(function (shipId) {
                    var ship = _g.data.ships[parseInt(shipId)];
                    return '<span class="item ship-exclude">' + ('' + ship._name) + '</span>';
                }).join('') + '</div>';
            }

            if (condition) return '<div class="ships">' + condition + '</div>';
        ...
        renderBonusSingle: function renderBonusSingle(bonus) {
            ...
            switch (this.type) {
                case 'ship':
                    {
                        condition = '<div class="equipments">' + _tmpl.link_equipment(bonus.equipment, undefined, !0) + '</div>';
                        break;
                    }
                case 'equipment':
                    {
            ...
            if (_typeof(bonus.bonusCount) === 'object') {
                ...
                Object.keys(bonus.bonusCount).sort(function (a, b) {
                    ...
                    bonusStats += '<div class="has-extra">' + ('<div class="extra count" data-count="' + count + '">' + count + '</div>') + _this17.renderStat(bonus.bonusCount[count]) + '</div>';
                });
            ...
            return $('<div class="bonus bonus-single">' + condition + '<div class="stats">' + ('<span class="info">' + bonusInfoText + '</span>') + bonusStats + '</div>' + '</div>');
        },
        renderBonusSet: function renderBonusSet(bonus) {
            ...
            return $('<div class="bonus bonus-set">' + condition + '<div class="equipments">' + bonus.list.map(function (item) {
                ...
                return '<div class="equipment">' + item + '</div>';
            }).join('') + '</div>' + '<div class="stats">' + ('<span class="info">' + bonusInfoText + '</span>') + bonusStats + '</div>' + '</div>');
        },
        ...
        getTitle: function getTitle() {
            switch (this.type) {
                case 'ship':
                    {
                        return $('<strong>' + this.ship._name + '</strong>' + '<span>\u88C5\u5907\u5C5E\u6027\u52A0\u6210</span>' + ('<img src="' + this.ship.getPic(10, _g.imgExt) + '" />'));
                    }
                case 'equipment':
                    {
                        return $('<strong>' + this.equipment._name + '</strong>' + '<span>\u5C5E\u6027\u52A0\u6210</span>' + ('<i style="background-image:url(assets/images/itemicon/' + this.equipment.getIconId() + '.png)"></i>'));
                    }
            }
        }
    };
...
var TablelistShips = function (_Tablelist) {
    ...
    function TablelistShips(container, options) {
        ...
        var _this19 = _possibleConstructorReturn(this, (TablelistShips.__proto__ || Object.getPrototypeOf(TablelistShips)).call(this, container, options));

        _this19.columns = ['  ', ['火力', 'fire'], ['雷装', 'torpedo'], ['夜战', 'nightpower'], ['对空', 'aa'], ['对潜', 'asw'], ['耐久', 'hp'], ['装甲', 'armor'], ['回避', 'evasion'], ['搭载', 'carry'], ['航速', 'speed'], ['射程', 'range'], ['索敌', 'los'], ['运', 'luck'], ['油耗', 'consum_fuel'], ['弹耗', 'consum_ammo'], ['多立绘', 'extra_illust']];
        _this19.header_checkbox = [];
        _this19.mode_selection_filters = $();

        _this19.rows = $();
        _this19.rowsById = {};
        _this19.rowsByHeader = {};


        _this19.functionsOnEnter = [];
        _this19.functionsOnExit = [];

        _frame.app_main.loading.push('tablelist_' + _this19._index);
        _frame.app_main.is_loaded = !1;

        _this19.initProgressMax = 0;
        _this19.initProgressCur = 0;

        _this19.dom.container.on({
                ...
                if (_g.getCurrentEvent().some(function (e) {
                    ...
                    var filter = function filter(_filter) {
                        ...
                        if (_filter) {
                            ...
                            _this20.dom.container.attr('data-leyte-fleet', _filter);
                        } else {
                            els._.addClass('on');
                            _this20.dom.container.removeAttr('data-leyte-fleet');
                        }
                    };
                ...
                _g.getCurrentEvent().filter(function (event) {
                    ...
                    var filter = function filter(_filter2) {
                        ...
                        if (_filter2) {
                            ...
                            _this20.dom.container.attr(attrName, _filter2);
                        } else {
                            els._.addClass('on');
                        ...
                        var _checkbox = tr.find('input[type="checkbox"]').on({
                            'change': function () {
                                this.rowsByHeader[header_index].filter(':visible').each(function (i, el) {
                                    this.check(el, _checkbox.prop('checked'), !0);
                                }.bind(this));
                            }.bind(this),
                            'docheck': function () {
...
var TablelistEquipments = function (_Tablelist2) {
    ...
    function TablelistEquipments(container, options) {
        ...
        var _this21 = _possibleConstructorReturn(this, (TablelistEquipments.__proto__ || Object.getPrototypeOf(TablelistEquipments)).call(this, container, options));

        _this21.columns = ['  ', ['火力', 'fire'], ['雷装', 'torpedo'], ['对空', 'aa'], ['对潜', 'asw'], ['爆装', 'bomb'], ['命中', 'hit'], ['装甲', 'armor'], ['回避', 'evasion'], ['索敌', 'los'], ['射程', 'range'], ['可改修', 'improvable']];

        _this21.equipmentsHasBonus = {};
    ...
    _createClass(TablelistEquipments, [{
        ...
        value: function apply_types() {
            ...
            if (TablelistEquipments.extraEquipments) {
                TablelistEquipments.extraEquipments.forEach(function (id) {
                    _this22.dom.tbody.children('[data-equipmentid="' + id + '"]').css({
                        display: 'flex',
                        opacity: 1
                    }).addClass('extra');
                });
        ...
        value: function apply_types_check() {
            ...
            if (TablelistEquipments.shipId === 'FIELD') {
                ...
                setTimeout(function () {
                    if (!_this23.dom.tbody.attr('scrollbody') || _this23.dom.tbody.attr('scrollbody') < 10) {
                        _this23.dom.tbody.scrollTop(scrollTop || 0);
                        _this23.dom.tbody.attr('scrollbody', scrollTop || 0);
                    }
                }, 100);
                return;
            }
                    ...
                    var parse = function parse() {
                        if (equipment) {
                            ...
                            if (Array.isArray(bonuses) && bonuses.length) {
                                _this24.equipmentsHasBonus[eid] = tr;
...
var TablelistFleets = function (_Tablelist3) {
    ...
    function TablelistFleets(container, options) {
        ...
        var _this25 = _possibleConstructorReturn(this, (TablelistFleets.__proto__ || Object.getPrototypeOf(TablelistFleets)).call(this, container, options));

        _this25.columns = ['  ', ['创建者', 'user'], ['修改时间', 'time_modify'], ['评价', 'rating'], ['', 'options']];

        _this25.kancolle_calc = {
        ...
        _frame.app_main.loading.push('tablelist_' + _this25._index);
        _frame.app_main.is_loaded = !1;

        _this25.dom.filter_container = $('<div class="options" viewtype="card"/>').appendTo(_this25.dom.container);
        _this25.dom.filters = $('<div class="filters"/>').appendTo(_this25.dom.filter_container);

        _this25.dom.btn_new = $('<button class="new" icon="import"/>').html('新建/导入').on('click', function (e, target) {
            this.btn_new(target);
        }.bind(_this25)).appendTo(_this25.dom.filters);
        if (TablelistFleets.support.buildfile) {
            _this25.dom.btn_exportFile = $('<button class="export" icon="floppy-disk"/>').html('导出配置文件').on('click', function () {
            ...
            }).appendTo(_this25.dom.filters);
        }

        _this25.dom.buttons_right = $('<div class="buttons_right"/>').appendTo(_this25.dom.filters);
        _this25.dom.setting_hqlv = $('<label/>', {
        ...
        }).append(_this25.dom.setting_hqlv_input = $('<input/>', {
            'type': 'number',
            'min': 0,
            'max': _g.hqMaxLv
        ...
        })).appendTo(_this25.dom.buttons_right);
        $body.on('update_defaultHqLv.update_fleets_hqlv_input', function (e, val) {
            this.dom.setting_hqlv_input.val(val);
        }.bind(_this25));
        _this25.dom.btn_settings = $('<button icon="cog"/>').on('click', function () {
            this.btn_settings();
        }.bind(_this25)).appendTo(_this25.dom.buttons_right);

        _this25.dom.table = $('<div class="tablelist-container"/>').appendTo(_this25.dom.container);
        _this25.dom.thead = $('<dl/>').appendTo($('<div class="tablelist-header"/>').appendTo(_this25.dom.table));
        _this25.dom.tbody = $('<div class="tablelist-body" scrollbody/>').appendTo(_this25.dom.table).on('contextmenu.contextmenu_fleet', '[data-fleetid]', function (e) {
            this.contextmenu_show($(e.currentTarget), null, e);
            e.preventDefault();
        }.bind(_this25)).on('click.contextmenu_fleet', '[data-fleetid]>dt>em', function (e) {
            this.contextmenu_show($(e.currentTarget).parent().parent(), $(e.currentTarget));
            e.stopImmediatePropagation();
            e.stopPropagation();
        }.bind(_this25));

        _this25.columns.forEach(function (v, i) {
        ...
        }.bind(_this25))))).appendTo(_this25.dom.table);

        _this25.dom.container.on('focus.number_input_select', 'input[type="number"]', function (e) {
            e.currentTarget.select();
        });
            ...
            if (Lockr.get('fleetlist-option-groupbytheme')) {
                (function () {
                    ...
                    for (var _i10 in sorted) {
                        ...
                        while (k < _this26.flexgrid_empty_count) {
                            if (!k) _this26.flexgrid_ph = $('<dl data-fleetid trindex="99999"/>').appendTo(_this26.dom.tbody);else $('<dl data-fleetid trindex="99999"/>').appendTo(_this26.dom.tbody);
                            k++;
                        }
                        ...
                        $('<h4/>', {
                            'trindex': ++_this26.trIndex,
                            'html': '&nbsp;'
                        }).appendTo(_this26.dom.tbody);
                        _this26.trIndex++;
                    }
                })();
            } else {
...
var TablelistEntities = function (_Tablelist4) {
    ...
    function TablelistEntities(container, options) {
        ...
        var _this27 = _possibleConstructorReturn(this, (TablelistEntities.__proto__ || Object.getPrototypeOf(TablelistEntities)).call(this, container, options));
        ...
        if (container.children('.tablelist-list').length) {
            _this27.init_parse();
        } else if (_this27.init_new) {
            _this27.init_new(options);
        }
        return _this27;
    }
    ...
    var _do = function _do(i, j) {
        if (_g.data.ship_id_by_type[i]) {
            if (!j) {
                ...
                _checkbox2 = undefined.create_title_checkbox(checkbox_id, i);

                undefined.header_checkbox[i] = _checkbox2;
            }
