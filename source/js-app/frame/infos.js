...
_frame.infos = {
    ...
    show_func: function (type, id, doNotPushHistory, infosHistoryIndex) {
        ...
        // 处理scrollbody
        // const lastScroll = this.dom.main.attr('scrollbody')
        // console.log(lastScroll)
        // if (!isNaN(lastScroll)) {
        //     this.dom.main.scrollTop(lastScroll)
        // }
        // this.dom.main.find('[scrollbody]')
        //     .off('scroll.scrollBody')
        //     .on('scroll.scrollBody', function (e) {
